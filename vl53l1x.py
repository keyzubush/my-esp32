...
class VL53L1X:
    ...
    def read(self):
        ...
        #     else:
        #         status = "OK"
        # print("sc=",stream_count,
        #     "dss=", dss_actual_effective_spads_sd0,
        #     "peak=", peak_signal_count_rate_mcps_sd0,
        #     "ambient=", ambient_count_rate_mcps_sd0,
        #     "sigma=", sigma_sd0,
        #     "phase=", phase_sd0,
        #     "final=", final_crosstalk_corrected_range_mm_sd0,
        #     "peaksignal=", peak_signal_count_rate_crosstalk_corrected_mcps_sd0)

        if peak_signal_count_rate_crosstalk_corrected_mcps_sd0 < 1950:
            final_crosstalk_corrected_range_mm_sd0 = int(2350 * 2.718 ** (-0.0064 * final_crosstalk_corrected_range_mm_sd0) + 850)
