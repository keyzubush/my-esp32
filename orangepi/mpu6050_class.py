...
class MPU6050:
    ...
    def get_data(self):
        ...
        # Include integrated values in the returned data
        data.update({
            'integrated_gyro_x': data['integrated_gyro_x'].value,
            'integrated_gyro_y': data['integrated_gyro_y'].value,
            'integrated_gyro_z': data['integrated_gyro_z'].value
        })
        return data
